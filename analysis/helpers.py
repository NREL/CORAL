...
allocations = {
    'Baseline-Low': {
        ...
        "towing_vessel": ('example_towing_vessel', 2), # =18 tugs (2 projects at a time, 3 groups per project, 3 tugs per group)
    ...
    'Baseline-Mid (SC)': {
        ...
        "array_cable_install_vessel": ('example_array_cable_lay_vessel', 4),
        "export_cable_install_vessel": ("example_export_cable_lay_vessel", 4),
    ...
    'Baseline-Mid (CC)': {
        ...
        "array_cable_install_vessel": ('example_array_cable_lay_vessel', 3),
        "export_cable_install_vessel": ("example_export_cable_lay_vessel",3),
    ...
    'Moderate-Mid (SC)': {
        ...
        "array_cable_install_vessel": ('example_array_cable_lay_vessel', 5),
        "export_cable_install_vessel": ("example_export_cable_lay_vessel",5),
    ...
    'Expanded-High': {
        ...
        "array_cable_install_vessel": ('example_array_cable_lay_vessel', 9),
        "export_cable_install_vessel": ("example_export_cable_lay_vessel",9),
